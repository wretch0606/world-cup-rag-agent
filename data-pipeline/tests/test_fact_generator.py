...
对齐 v2 更新：
- generate_all_match_facts 签名改为 (matches, teams, source_id, source_url, source_page, tournament_host)
...
class TestGenerateMatchFact:
    def test_regulation_fact(self):
        match = Match(
            ...
            tournament_year=2018, match_date="2018-07-15",
            stage="final", stage_name="决赛", venue="卢日尼基体育场",
            home_team_id="team_FRA", away_team_id="team_CRO",
            home_score_90=4, away_score_90=2,
            winner_team_id="team_FRA", result_type="regulation",
            score_display="4:2",
        )
    ...
    def test_extra_time_fact(self):
        match = Match(
            ...
            tournament_year=2018, match_date="2018-07-11",
            stage="semi_final", stage_name="半决赛", venue="卢日尼基体育场",
            home_team_id="team_CRO", away_team_id="team_ENG",
            home_score_90=1, away_score_90=1,
            home_score_et=2, away_score_et=1,
            winner_team_id="team_CRO", result_type="extra_time",
            score_display="2:1",
        )
    ...
    def test_penalties_fact(self):
        match = Match(
            ...
            tournament_year=2022, match_date="2022-12-18",
            stage="final", stage_name="决赛", venue="卢赛尔体育场",
            home_team_id="team_ARG", away_team_id="team_FRA",
            home_score_90=2, away_score_90=2,
            home_score_et=3, away_score_et=3,
            home_penalties=4, away_penalties=2,
            winner_team_id="team_ARG", result_type="penalties",
    ...
    def test_draw_fact(self):
        match = Match(
            ...
            tournament_year=2018, match_date="2018-06-15",
            stage="group", stage_name="小组赛",
            home_team_id="team_POR", away_team_id="team_ESP",
            home_score_90=3, away_score_90=3,
            winner_team_id=None, result_type="draw",
            score_display="3:3",
        )
...
class TestGenerateTournamentSummary:
    def test_summary_with_data(self):
        matches = [
            Match(match_id="WC2018_FRA_CRO_final", tournament_year=2018,
                  match_date="2018-07-15", stage="final", stage_name="决赛",
                  home_team_id="team_FRA", away_team_id="team_CRO",
                  home_score_90=4, away_score_90=2,
                  winner_team_id="team_FRA", result_type="regulation",
                  score_display="4:2"),
            Match(match_id="WC2018_BEL_ENG_3rd", tournament_year=2018,
                  match_date="2018-07-14", stage="third_place", stage_name="三四名决赛",
                  home_team_id="team_BEL", away_team_id="team_ENG",
                  home_score_90=2, away_score_90=0,
                  winner_team_id="team_BEL", result_type="regulation",
                  score_display="2:0"),
        ]
        teams = {"team_FRA": TEAM_FRA, "team_CRO": TEAM_CRO,
                 "team_BEL": TEAM_BEL, "team_ENG": TEAM_ENG}
    ...
    def test_batch_generation(self):
        ...
        matches = [
            Match(match_id="WC2018_FRA_CRO_final", tournament_year=2018,
                  ...
                  home_score_90=4, away_score_90=2,
                  winner_team_id="team_FRA", result_type="regulation",
                  score_display="4:2", data_version="2026-07-16-v2"),
        ]
        teams = {"team_FRA": TEAM_FRA, "team_CRO": TEAM_CRO}
        ...
        assert record["metadata"]["source_id"] == "src_test_001"
